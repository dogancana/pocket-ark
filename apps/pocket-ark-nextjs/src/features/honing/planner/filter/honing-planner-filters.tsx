              ...
              <>
                ...
                >
                  <p className="max-w-2xl">
                    To calculate on expected honing number, we simply expect you
                    to pass through enough honing attempts to reach this number.
                    <br />
                    If there are 6 attempts with 20% success rate each, <br />
                    <ul>
                      <li>
                        with probability of 30, you'll be successful on 2nd
                        attempt.
                      </li>
                      <li>
                        with probability of 40, you'll be successful on 2nd
                        attempt.
                      </li>
                      <li>
                        with probability of 50, you'll be successful on 3rd
                        attempt.
                      </li>
                    </ul>
                    ...
                    average cost in gold. Average cost in gold is calculated
                    based on probablity of each attempt individualy. <br />
